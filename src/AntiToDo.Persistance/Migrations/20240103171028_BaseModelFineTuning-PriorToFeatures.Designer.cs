...
namespace AntiToDo.Persistance.Migrations
{
    ...
    [Migration("20240103171028_BaseModelFineTuning-PriorToFeatures")]
    partial class BaseModelFineTuningPriorToFeatures
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AntiToDo.Domain.User", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("AntiToDo.Domain.Estimation", b =>
                {
                    b.HasOne("AntiToDo.Domain.User", "User")
                        .WithMany()
